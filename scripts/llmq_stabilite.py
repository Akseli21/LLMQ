# ============================================================
# llmq_stabilite.py
# Script LLMQ — Test de stabilité LLaMA + Gemma
# 15 cas × 3 reformulations × 2 modèles × 3 répétitions = 90 requêtes
#
...
OUTPUT_FILE = "results/resultats_llmq_stabilite.json"
...
def extraire_score(reponse):
    ...
    Le modèle est invité à terminer sa réponse par :
...
def envoyer_prompt(model, contexte, demande):
    ...
    Inclut l'instruction d'auto-évaluation de la confiance.
    """
    message = f"""{contexte}
